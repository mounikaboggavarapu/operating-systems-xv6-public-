...
int main(int argc, char *argv[]) {
  ...
  exit();
  47:	e8 67 02 00 00       	call   2b3 <exit>
    printf(2, "Error: Please give the positive sleep time\n");
  4c:	50                   	push   %eax
  4d:	50                   	push   %eax
  4e:	68 60 07 00 00       	push   $0x760
  53:	6a 02                	push   $0x2
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 ec 07 00 00 	movzbl 0x7ec(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 94 07 00 00 	jmp    *0x794(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 8c 07 00 00       	mov    $0x78c,%edx
        while(*s != 0){
